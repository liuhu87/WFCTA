 ...
 * *****************************/
void WFCTAEvent::Deal81Package(uint8_t *begin, int packsize, float *HV)
{
    head = packsize - 72;
 ...
 * *****************************/
void WFCTAEvent::Deal82Package(uint8_t *begin, int packsize, float *PreTemp)
{
    head = packsize - 72;
    //dumpPacket(begin+head,72,16);
 ...
 * ****************************/
uint64_t  WFCTAEvent::GetStatusReadbackTime(uint8_t *begin, int packsize)
{
...
uint64_t  WFCTAEvent::GetStatusReadbacktime(uint8_t *begin, int packsize)
{
    uint64_t m_status_readback_time = (((uint64_t)begin[packsize-7]&0x03)<<24)|
