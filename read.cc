...
/*
          if(status_pack_marker>10){
            switch(Package_marker){
              case 0x21:
                wfctaDecode->Deal21Package((short *)single_thresh, (short *)record_thresh);
                break;
              case 0x22:
                wfctaDecode->Deal22Package((long *)single_count,(float *)DbTemp);
                break;
              case 0x23:
                wfctaDecode->Deal23Package((long *)single_count,(long *)single_time);
                break;
              case 0x81:
                wfctaDecode->Deal81Package((float *)HV);
                break;
              case 0x82:
                wfctaDecode->Deal82Package((float *)PreTemp);
                break;
              case 0x83:
              ...
              case 0x84:
                ...
                break;
              case 0x85:
                wfctaDecode->Deal85Package((long *)ClbTime,(float *)ClbTemp);
                break;
            }
          }
          ...
          if(FPGA_marker==0){
            wfctaDecode->DealF9Package((int *)fpgaVersion);
